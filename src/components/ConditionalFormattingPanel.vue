<template>
      ...
      <div class="panel-body">
        ...
        <div class="format-rules mb-3">
          ...
          <div class="mb-3 rule-criteria">
            ...
            <!-- Double criterion input (for between/not between) -->
          ...
          <div class="mb-3">
            ...
            <div class="format-preview mb-2 p-2 border rounded d-flex justify-content-center align-items-center"
                 :style="{
            ...
            <div class="formatting-options d-flex flex-wrap gap-2">
              ...
              <button 
                class="btn btn-sm"
                :class="{ 'btn-primary': selectedFormat.underline, 'btn-light': !selectedFormat.underline }"
        ...
        <!-- Rules list (when editing or viewing existing rules) -->
  ...
  const filteredRules = computed(() => {
    // Get rules that affect the currently selected range
  ...
  /**
   * Format rule range to human-readable text
   */
  ...
  /**
   * Format rule condition to human-readable text
   */
  ...
  /**
   * Get placeholder text for criterion input based on rule type
   */
  ...
  const onRangeInputClick = () => {
    // This would typically open a range selector or set focus to the grid
